...
**Primary practice:** CSS selectors, color, transforms, and hover states

## What I built

The first styled content page applies background color, selector-based styling, a transform, and a hover treatment to a semantic reading layout.
